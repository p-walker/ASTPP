...
-->
        ...
        {display: 'UniqueID', name: 'country', width: 80, sortable: false, align: 'center'},
        {display: 'Date', name: 'province', width: 100, sortable: false, align: 'center'},
        ...
        {display: 'Pattern', name: 'xfers', width: 80, sortable: false, align: 'center'},
		],
    buttons : [
