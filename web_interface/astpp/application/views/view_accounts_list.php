...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#flex1").flexigrid({
            ...
            pagestat: 'Displaying {from} to {to} of {total} Accounts',
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select name="account_number_operator" class="field select">
                                    <option value="1" <?php if (@$account_search['account_number_operator'] == 1) {
            echo "selected";
        } ?> >contains</option>
                                    <option value="2" <?php if (@$account_search['account_number_operator'] == 2) {
            echo "selected";
        } ?>>doesn't contain</option>
                                    <option value="3" <?php if (@$account_search['account_number_operator'] == 3) {
            echo "selected";
        } ?>>is equal to</option>
                                    <option value="4" <?php if (@$account_search['account_number_operator'] == 4) {
            echo "selected";
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select name="first_name_operator" class="field select">
                                    <option value="1" <?php if (@$account_search['first_name_operator'] == 1) {
    echo "selected";
} ?>>contains</option>
                                    <option value="2" <?php if (@$account_search['first_name_operator'] == 2) {
    echo "selected";
} ?>>doesn't contain</option>
                                    <option value="3" <?php if (@$account_search['first_name_operator'] == 3) {
    echo "selected";
} ?>>is equal to</option>
                                    <option value="4" <?php if (@$account_search['first_name_operator'] == 4) {
    echo "selected";
} ?>>is not equal to</option>
                                </select>
                            </span>
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select name="last_name_operator"  class="field select">
                                    <option value="1" <?php if (@$account_search['last_name_operator'] == 1) {
    echo "selected";
} ?> >contains</option>
                                    <option value="2" <?php if (@$account_search['last_name_operator'] == 2) {
    echo "selected";
} ?>>doesn't contain</option>
                                    <option value="3" <?php if (@$account_search['last_name_operator'] == 3) {
    echo "selected";
} ?>>is equal to</option>
                                    <option value="4" <?php if (@$account_search['last_name_operator'] == 4) {
    echo "selected";
} ?>>is not equal to</option>
                                </select>
                            </span>
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select name="company_operator"  class="field select ">
                                    <option value="1" <?php if (@$account_search['company_operator'] == 1) {
    echo "selected";
} ?> >contains</option>
                                    <option value="2" <?php if (@$account_search['company_operator'] == 2) {
    echo "selected";
} ?>>doesn't contain</option>
                                    <option value="3" <?php if (@$account_search['company_operator'] == 3) {
    echo "selected";
} ?> >is equal to</option>
                                    <option value="4" <?php if (@$account_search['company_operator'] == 4) {
    echo "selected";
} ?> >is not equal to</option>
                                </select>
                            </span>
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select name="balance_operator" class="field select" style="width:132px;" >
                                    <option value="1" <?php if (@$account_search['balance_operator'] == 1) {
    echo "selected";
} ?> >is equal to</option>
                                    <option value="2" <?php if (@$account_search['balance_operator'] == 2) {
                                    echo "selected";
                                } ?>>is not equal to</option>
                                    <option value="3" <?php if (@$account_search['balance_operator'] == 3) {
                                    echo "selected";
                                } ?>>greater than</option>
                                    <option value="4" <?php if (@$account_search['balance_operator'] == 4) {
                                    echo "selected";
                                } ?>>less than</option>
                                    <option value="5" <?php if (@$account_search['balance_operator'] == 5) {
                                    echo "selected";
                                } ?>>greather or equal than</option>
                                    <option value="6" <?php if (@$account_search['balance_operator'] == 6) {
                                    echo "selected";
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select name="creditlimit_operator" class="field select" style="width:132px;"  >
                                    <option value="1" <?php if (@$account_search['creditlimit_operator'] == 1) {
                                    echo "selected";
                                } ?> >is equal to</option>
                                    <option value="2"  <?php if (@$account_search['creditlimit_operator'] == 2) {
                                    echo "selected";
                                } ?>>is not equal to</option>
                                    <option value="3"  <?php if (@$account_search['creditlimit_operator'] == 3) {
                                    echo "selected";
                                } ?>>greater than</option>
                                    <option value="4"  <?php if (@$account_search['creditlimit_operator'] == 4) {
                                    echo "selected";
                                } ?>>less than</option>
                                    <option value="5"  <?php if (@$account_search['creditlimit_operator'] == 5) {
                                    echo "selected";
                                } ?>>greather or equal than</option>
                                    <option value="6"  <?php if (@$account_search['creditlimit_operator'] == 6) {
                                    echo "selected";
                                } ?>>less or equal than</option>
                                </select>
                            </span>
                        ...
                        <div class="float-left" style="width:30%">
                            <span>
                                ...
                                <select class="select field" name="posttoexternal" style="width:307px;" >
                                    ...
                                    <option value="1" <?php if (@$account_search['desc'] == '1') {
    echo "selected";
} ?> >YES</option>
                                    <option value="0" <?php if (@$account_search['desc'] == '0') {
    echo "selected";
} ?>>NO</option>
                                </select>
                            </span>
