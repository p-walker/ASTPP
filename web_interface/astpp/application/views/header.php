...
<div class="dropdown_4columns">
	...
	<div class="col_1">            
	  ...
	  <ul >
	      ...
	      <li><a href="<?php echo base_url();?>accounting/invoiceconf/"><img src="<?=base_url()?>assets/images/menu_icons/Accounting/InvoiceConf.png" border="0" width="16" height="16" />&nbsp;&nbsp;Invoice Configuration</a></li>                 
	  </ul>
	</div>
	  ...
	  <h3>Manage Taxes</h3>
	  <ul >
	      <li><a href="<?php echo base_url();?>systems/taxes/"><img src="<?=base_url()?>assets/images/menu_icons/System/Taxes.png" border="0" width="16" height="16" />&nbsp;&nbsp;Taxes</a></li>
    ...
    <div class="dropdown_3columns">
	  ...
	  <h3>Providers</h3>
	    <ul class="simple">
		  ...
		  <li><a href="<?php echo base_url();?>lcr/trunks/"><img src="<?=base_url()?>assets/images/menu_icons/LCR/Trunks.png" border="0" width="16" height="16" />&nbsp;&nbsp;Trunks</a></li>
...
<div class="dropdown_3columns">
	...
	<div class="col_1">            
	  ...
	  <ul>
	    ...
	    <li><a href="<?php echo base_url();?>cdrReports/providerReport/"><img src="<?=base_url()?>assets/images/menu_icons/CDR/cdr.png" border="0" width="16" height="16" />&nbsp;&nbsp;Provider Report</a></li>      
	  </ul>
	</div>  
	...
	<div class="col_1">            
	  ...
	  <ul>
		  ...
		  <li><a href="<?php echo base_url();?>adminReports/providerReport/"><img src="<?=base_url()?>assets/images/menu_icons/AdminReports/ResellerReports.png" border="0" width="16" height="16" />&nbsp;&nbsp;Provider Report</a></li>
	  </ul>
	</div>
	<div class="col_1">            
